<div class="fullscreen-ui">
	<div class="navbar navbar-toolbar">
		<div class="btn-toolbar">
			<div class="btn-group">
				<a href="/Prime/Field/Create/<?=$resource_id;?>?type=<?=Arr::get($_GET, 'type', NULL);?>&amp;back=<?=Arr::get($_GET, 'back', NULL);?>" onclick="return Prime.LoadView(this.href);" class="btn btn-default"><i class="icon-file-text"></i>&nbsp; Create</a>
			</div>
			<div class="btn-group">
			...
			<?php if (Arr::get($_GET, 'back', NULL) !== NULL): ?>
				<div class="pull-right">
					<div class="btn-group">
						<a href="<?=Arr::get($_GET, 'back', NULL);?>" onclick="return Prime.LoadView(this.href);" class="btn btn-default">Go back</a>
					</div>
				</div>
			<?php endif; ?>
		</div>
		...
		<table class="table table-hover table-condensed table-selection table-dnd" data-reorder-api="/Prime/Field/Reorder">
			...
			<tbody>
				<?php foreach ($fields as $field): ?>
					<tr data-id="<?=$field->id;?>" ondblclick="Prime.LoadView('/Prime/Field/Edit/<?=$field->id;?>?type=<?=Arr::get($_GET, 'type', NULL);?>&amp;back=<?=Arr::get($_GET, 'back', NULL);?>');" onselectstart="return false;">
