	...
	<div class="controls">
		<div class="input-group">
			...
			<div class="input-group-btn">
				...
				<a href="#" onclick="return prime.page.region.template_settings(this, '<?=$field['name'];?>', prime.crc32('views/<?=Arr::get($options, 'directory');?>/'+$(this).parent().prev().val()+'.php'));" class="btn btn-default" style="margin: -2px 0 0 0px; padding: 4px 12px; border-radius: 2px;"><?=__('Settings');?></a>
			</div>
		</div>
		<?php if ($error): ?>
