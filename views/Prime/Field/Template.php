	...
	<div class="controls">
		<div class="input-group">
			...
			<div class="input-group-btn">
				...
				<a href="#" onclick="prime.dialog({ remote: '/Prime/Field/Settings/Template:' + prime.crc32('views/<?=Arr::get($options, 'directory');?>/'+$(this).parent().prev().val()+'.php') }); return false;" class="btn btn-default" style="margin: -2px 0 0 0px; padding: 4px 12px; border-radius: 2px;">Settings</a>
			</div>
		</div>
		<?php if ($error): ?>
