<ul class="nav nav-tabs" style="margin: -10px;">
	<li class="active" style="display: table-cell;float: none;width: 1%; text-align: center;">
		<a href="#rightPanelPage" data-toggle="tab" style="border-bottom-color: transparent;" class="page-tab">Page</a>
	</li>
	<li style="display: table-cell;float: none;width: 1%;text-align: center;">
		<a href="#rightPanelRegion" data-toggle="tab" style="border-bottom-color: transparent;" class="region-tab">Region</a>
	</li>
</ul>
<br>
<div class="tab-content">
	<div class="tab-pane active" id="rightPanelPage">
		<span class="nav-header">Modules</span>
