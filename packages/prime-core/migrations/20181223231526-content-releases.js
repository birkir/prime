...
exports.up = async db => {
  ...
  await db.runSql(
    'ALTER TABLE "ContentEntry" ADD CONSTRAINT "ContentEntry_contentReleaseId_fkey" FOREIGN KEY ("contentReleaseId") REFERENCES "ContentRelease"(id) ON UPDATE SET NULL ON DELETE SET NULL'
  );
  return null;
};
...
exports.down = async db => {
  ...
  await db.runSql('ALTER TABLE "ContentEntry" DROP CONSTRAINT IF EXISTS "ContentEntry_contentReleaseId_fkey"');
  await db.runSql(
    'ALTER TABLE "ContentEntry" ADD CONSTRAINT "ContentEntry_contentReleaseId_fkey" FOREIGN KEY ("contentReleaseId") REFERENCES "ContentRelease"(id) ON UPDATE CASCADE'
  );
  return null;
};
