...
(function ($) {
	...
	$.vakata.dnd = {
		...
		drag_start : function (e, data, html) { 
			...
			$.vakata.dnd.helper = $("<div id='vakata-dragged' />").html(html).addClass('btn') //.fadeTo(10,0.25);
	...
	$.vakata.context = {
		...
		parse	: function (s, is_callback) {
			...
			$.each(s, function (i, val) {
				...
				was_sep = false;
				str += "<li class='" + (val._class || "") + (val._disabled ? " disabled " : "") + (val.submenu ? ' dropdown-submenu' : '') + "'><ins ";
			...
			str = str.replace(/<li class\='divider'\><\/li\>$/,"");
			str += "</ul>";
	...
	$.jstree.plugin("contextmenu", {
		...
		_fn : {
			show_contextmenu : function (obj, x, y) {
				...
				if(this.data.themes) {
				//	$.vakata.context.cnt.children('ul').addClass('dropdown-menu');
				}
			}
		}
	});
