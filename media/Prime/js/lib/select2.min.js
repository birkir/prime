    ...
    SingleSelect2 = clazz(AbstractSelect2, {
		...
		createContainer: function () {
            var container = $(document.createElement("div")).attr({
                ...
                "   <span></span><abbr class='select2-search-choice-close' style='display:none;'>Ã—</abbr>",
                "   <div><b></b></div>" ,
                "</a>",
        ...
        addSelectedChoice: function (data) {
            var enableChoice = !data.locked,
                enabledItem = $(
                    ...
                    "    <div></div>" +
                    "    <a href='#' onclick='return false;' class='select2-search-choice-close' tabindex='-1'>Ã—</a>" +
                    "</li>"),
                disabledItem = $(
